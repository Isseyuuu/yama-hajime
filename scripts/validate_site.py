...
listed={urlparse(n.text).path.removeprefix('/yama-hajime/').rstrip('/') for n in tree.findall('.//s:loc',ns)}
expected={'','about.html','privacy.html','articles/mountain-hiking-start.html','articles/trekking-start.html','articles/swimming-start.html'}
